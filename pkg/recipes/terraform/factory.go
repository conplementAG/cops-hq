...
//     subscriptionId and tenantId (required for terraform state, and will also be provided to your terraform code
//         via subscription_id and tenant_id terraform variables)
//     region (Azure region, e.g. westeurope, will be provided to your terraform code via region terraform variable)
